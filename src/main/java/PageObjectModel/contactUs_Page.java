...
public class contactUs_Page extends AbstractClass {
    ...
    public void clickContactUsButton(){
        ...
        clickFunction(contactUsButton);   //Abstract classtaki methoda göre şekil verdik
    }
    ...
    public void typeEmail(){
        ...
        sendKeysFunction(emailTextArea,"emrekrdenz@gmail.com");
    }
    ...
    public void typeMessage(){
        ...
        sendKeysFunction(messageBox,"Selam şu an MessageBox'a yazı yazıyorum...");
    }
